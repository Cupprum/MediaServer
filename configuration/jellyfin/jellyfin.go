...
func GetConfig() (*Config, error) {
	...
	c.AccessToken = `MediaBrowser Client="Jellyfin", Device="TestScript", DeviceId="1", Version="10.11.0"`

	if c.Url, err = utils.RequireEnv("MEDIASERVER_JELLYFIN_URL"); err != nil {
		return nil, err
	}
	if c.Username, err = utils.RequireEnv("MEDIASERVER_JELLYFIN_USERNAME"); err != nil {
		return nil, err
	}
	...
	if c.OpenSubtitlesPassword, err = utils.RequireEnv("MEDIASERVER_JELLYFIN_OPENSUBTITLES_PASSWORD"); err != nil {
		return nil, err
	}
	return c, nil
}
